...
const Signup = () =>{
        ...
        const signUpForm = () =>(
                <form>
                        ...
                        <button onClick={clickSubmit} className="button1">
                                Submit
                        </button>
                </form>
        )
        ...
        return(         
        <Layout title="Signup" description="Signup now to avail amazing discounts!" className="container col-md-8 offset-md-2">
